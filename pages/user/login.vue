                    ...
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <input class="form-control" required placeholder="Email" v-model="admins.email" type="email" autofocus="">
                            </div>
                            <div class="form-group">
                                <input class="form-control" required placeholder="Password" v-model="admins.password" type="password" value="">
                                </div>
                                <div class="checkbox">
                                <label>
