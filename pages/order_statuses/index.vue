...
export default {
    ...
    methods : {
        getOrderStatuses : function(){
            let self = this
            this.$axios.get('/order_statuses?search='+this.search+'&currentPage='+this.pagination.currentPage+'&perPage='+this.pagination.perPage)
            .then(function(res){
                console.log(res)
         ...
         handleDelete: function(id){
            let self = this
            this.$axios.delete('/order_statuses/'+id)
            .then(function(res){
                console.log(res)
