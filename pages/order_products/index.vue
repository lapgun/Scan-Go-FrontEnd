...
export default {
    ...
    methods : {
        getOrderProducts : function(){
            let self = this
            this.$axios.get('/order_products?search='+this.search+'&currentPage='+this.pagination.currentPage+'&perPage='+this.pagination.perPage)
            .then(function(res){
                console.log(res)
         ...
         handleDelete: function(id){
            let self = this
            this.$axios.delete('/order_products/'+id)
            .then(function(res){
                console.log(res)
